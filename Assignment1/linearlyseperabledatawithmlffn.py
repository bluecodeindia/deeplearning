# -*- coding: utf-8 -*-
"""LinearlySeperableDataWithMLFFN.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1RLY2lcQoUlzxC45BPbEnBa_1JmIYOYOD
"""
...
data,data_size,Test,test_size=data_format(sigmoid,File)
Train,Validation,T_size,V_size=cross_validation(k,data)
Weights=classifier(data,archicture,epoch,sigmoid,learning_rate)
...
neuron_output(Train,output1,3,0,File,'LS_Output_Neuron_Train')
